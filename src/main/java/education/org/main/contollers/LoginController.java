...
public class LoginController {
   ...
   private LoginService loginService;
    ...
    public JwtTokenDto loginService(@RequestBody LoginViewModel login , HttpServletResponse response) {
    	Map<String, String> tokens=new HashMap<String, String>();
    	LOGGER.info("Authentication operation => begin",login.getUsername());
        try {
        		Authentication auth= loginService.authenticate(login);
